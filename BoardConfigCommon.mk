...
BOARD_RECOVERY_BOARD_NAME := SRPUJ28A006

BOARD_VENDOR_BOOT_MKBOOTIMG_ARGS := --kernel_offset 0x00008000
BOARD_VENDOR_BOOT_MKBOOTIMG_ARGS += --ramdisk_offset 0x00000000
BOARD_VENDOR_BOOT_MKBOOTIMG_ARGS += --tags_offset 0x00000000
BOARD_VENDOR_BOOT_MKBOOTIMG_ARGS += --board $(BOARD_RECOVERY_BOARD_NAME)
BOARD_RECOVERY_MKBOOTIMG_ARGS := $(BOARD_VENDOR_BOOT_MKBOOTIMG_ARGS)

BOARD_RECOVERY_MKBOOTIMG_ARGS += --second_offset 0xf0000000
BOARD_RECOVERY_MKBOOTIMG_ARGS += --dtb_offset 0x00000000
BOARD_RECOVERY_MKBOOTIMG_ARGS += --header_version 2

BOARD_VENDOR_BOOT_MKBOOTIMG_ARGS += --dtb_offset 0x01f00000
BOARD_VENDOR_BOOT_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION)
